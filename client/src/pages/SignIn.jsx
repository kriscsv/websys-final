...
// ─── Hardcoded admin fallback (remove once backend is live) ───────────────────
const ADMIN_EMAIL    = "admin@bu.edu.ph";
...
export default function SignIn() {
  ...
  const handleSignIn = async (e) => {
    ...
    try {
      // ── Calls server/routes/authRoutes.js → controllers/authController.js ──
      ...
      // Save to localStorage — use these anywhere in the app
      // localStorage.getItem("token") → JWT for protected API calls
      // localStorage.getItem("role")  → "admin" or "student"
      // localStorage.getItem("user")  → full user object as JSON string
      ...
      // ── Fallback while backend is not yet running ─────────────────────────
      // Delete this block once your MySQL server is live
        ...
        <div style={{
          ...
          <div style={{
            ...
            <div style={{ display:"grid", gridTemplateColumns:"1fr 1fr 1fr", gap:"10px" }}>
              <button onMouseEnter={e => e.currentTarget.style.background="#e8e8e8"} onMouseLeave={e => e.currentTarget.style.background="#f4f4f4"}
